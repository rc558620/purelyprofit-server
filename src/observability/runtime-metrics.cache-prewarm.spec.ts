...
function createCycleSnapshot(
  ...
  return {
    ...
    durationDistribution: {
      ...
      financeReport: createDurationDistribution(0, 0, 0, 0),
      profitDetail: createDurationDistribution(0, 0, 0, 0),
      profitReport: createDurationDistribution(0, 0, 0, 0),
      costsStats: createDurationDistribution(0, 0, 0, 0),
      costsReport: createDurationDistribution(0, 0, 0, 0),
    },
    slowKeySamples: [],
