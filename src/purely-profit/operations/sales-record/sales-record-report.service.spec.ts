    ...
    prismaService.saleOrder.findMany.mockResolvedValue([
      {
        ...
        totalRevenue: new Prisma.Decimal('3650'),
        totalProfit: new Prisma.Decimal('920'),
        totalQuantity: 3,
        paymentMethod: 'cash',
        calcMode: 'business',
        note: null,
        ...
        items: [
          ...
          },
          {
            ...
            productName: '手冲咖啡',
            categoryName: '饮品',
            salePrice: new Prisma.Decimal('2350'),
            profit: new Prisma.Decimal('420'),
            quantity: 1,
            image: null,
            createdAt: new Date('2026-05-14T10:10:00.000Z'),
          },
  ...
  it('getReport 在同日同商品跨订单时按聚合行统计 orderCount', async () => {
    ...
    prismaService.saleOrder.findMany.mockResolvedValue([
      ...
      },
      {
        ...
        totalRevenue: new Prisma.Decimal('650'),
        totalProfit: new Prisma.Decimal('250'),
        totalQuantity: 1,
        paymentMethod: 'cash',
        calcMode: 'business',
        note: null,
    ...
    prismaService.saleOrder.findMany.mockResolvedValue([
      {
        ...
        totalRevenue: new Prisma.Decimal('3400'),
        totalProfit: new Prisma.Decimal('3400'),
        totalQuantity: 2,
        paymentMethod: 'cash',
        calcMode: 'business',
        note: null,
      ...
      },
      {
        ...
        totalRevenue: new Prisma.Decimal('800'),
      ...
      },
      {
        ...
        totalRevenue: new Prisma.Decimal('-500'),
        totalProfit: new Prisma.Decimal('-500'),
        totalQuantity: 0,
        paymentMethod: 'wechat',
        calcMode: 'business',
