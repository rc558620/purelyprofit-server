    ...
    const preparedItems = [
      {
        ...
        productName: '台位费（固定）',
        categoryName: '场地费',
        salePrice: Money.fromInputYuan(666),
        profit: Money.fromInputYuan(666),
        quantity: 1,
        countsTowardTotalQuantity: true,
      },
    ];
    ...
    const preparedItems = [
      {
        ...
        productName: '台位费（固定）',
        categoryName: '场地费',
        salePrice: Money.fromInputYuan(100),
        profit: Money.fromInputYuan(100),
        quantity: 1,
        countsTowardTotalQuantity: true,
      },
    ];
