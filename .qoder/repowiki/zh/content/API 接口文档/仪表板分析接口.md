...
**重大更新**：仪表板首页新增8种智能动态活动类型，包括今日新会员注册、充值交易、即将到来的预约、即将到期账款、待确认工资单、高价值会员久未到店、营收连续下滑等，显著提升业务智能分析能力。
...
## 架构总览
下图展示了从控制器到服务、查询构建与映射的整体调用链路，包括新增的动态活动处理流程。
...
- [business-analysis.controller.ts:1-200](file://src/purely-profit/dashboard/business-analysis/business-analysis.controller.ts#L1-L200)
- [business-analysis.service.ts:1-300](file://src/purely-profit/dashboard/business-analysis/business-analysis.service.ts#L1-L300)
- [business-analysis.query.ts:1-200](file://src/purely-profit/dashboard/business-analysis/business-analysis.query.ts#L1-L200)
...
- [dashboard-home.controller.ts:1-200](file://src/purely-profit/dashboard/dashboard-home/dashboard-home.controller.ts#L1-L200)
- [dashboard-home.service.ts:1-300](file://src/purely-profit/dashboard/dashboard-home/dashboard-home.service.ts#L1-L300)
- [dashboard-home.query.ts:1-200](file://src/purely-profit/dashboard/dashboard-home/dashboard-home.query.ts#L1-L200)
...
- [profit-detail.mapper.ts:1-200](file://src/purely-profit/dashboard/profit-detail/profit-detail.mapper.ts#L1-L200)
...
- [dashboard-home.constants.ts:19-104](file://src/purely-profit/dashboard/dashboard-home/dashboard-home.constants.ts#L19-L104)
...
**章节来源**
- [business-analysis.types.ts:1-200](file://src/purely-profit/dashboard/business-analysis/business-analysis.types.ts#L1-L200)
- [dashboard-home.types.ts:1-200](file://src/purely-profit/dashboard/dashboard-home/dashboard-home.types.ts#L1-L200)
- [profit-detail.types.ts:1-200](file://src/purely-profit/dashboard/profit-detail/profit-detail.types.ts#L1-L200)
...
## 结论
本文档梳理了仪表板与分析模块的 API 规范，明确了业务概览、销售趋势、利润明细与脉动仪表板的端点职责、输入参数、输出格式与数据流。**重大更新**：dashboard-home服务新增8种智能动态活动类型，包括今日新会员注册、充值交易、即将到来的预约、即将到期账款、待确认工资单、高价值会员久未到店、营收连续下滑等，显著提升了业务智能分析能力。

通过统一的查询构建与映射机制，配合缓存与查询优化策略，可在保证实时性的同时提升整体性能与可维护性。新增的动态活动类型为管理层提供了更全面的业务洞察，有助于及时发现业务机会与风险，提升运营效率。