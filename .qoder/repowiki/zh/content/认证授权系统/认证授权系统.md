...
## 更新摘要
**所做更改**
- 新增SMS冷却功能，使用Redis setIfAbsent操作实现速率限制
- 支持注册、密码重置和登录操作的独立冷却周期
- 增强验证码服务的防滥用能力，防止短信轰炸
- 优化验证码发送流程，提升系统稳定性
...
**更新** 新增SMS冷却功能，通过Redis setIfAbsent操作实现精确的速率限制，防止恶意刷短信攻击，确保系统的公平使用。该功能支持注册、密码重置和登录操作的独立冷却周期，提升了系统的安全性和稳定性。
...
**图表来源**
- [auth-code.service.ts:259-281](file://src/purely-profit/auth/auth-code.service.ts#L259-L281)
- [redis.service.ts:148-167](file://src/redis/redis.service.ts#L148-L167)

**章节来源**
- [auth-code.service.ts:259-281](file://src/purely-profit/auth/auth-code.service.ts#L259-L281)
- [redis.service.ts:148-167](file://src/redis/redis.service.ts#L148-L167)
- [auth.constants.ts:4](file://src/purely-profit/auth/auth.constants.ts#L4)
...
- **SMS冷却功能异常**
  ...
  - 参考：[auth-code.service.ts:259-281](file://src/purely-profit/auth/auth-code.service.ts#L259-L281)、[redis.service.ts:148-167](file://src/redis/redis.service.ts#L148-L167)
